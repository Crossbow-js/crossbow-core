...
var Compiler = (function () {
    ...
    _createClass(Compiler, [{
        ...
        value: function parse(_ref) {
            ...
            var compiler = this;
            var ast = _srcParser2['default'].parse(content);
            (0, _fs.writeFileSync)('ast.json', JSON.stringify(ast, null, 4));
        ...
        value: function process(_ref2) {
            ...
            ast = (0, _astTransforms.formattingPass)({ ast: ast, compiler: compiler, ctx: ctx });
        ...
        value: function getValue(paths) {
            ...
            if (prev > -1) {
                ...
                while (startingpoint > -1) {
                    ...
                    var lookup = paths.slice(0, startingpoint).concat(afters);
                    var value = compiler._ctx.getIn(lookup);
